...
const reasons = [
  "সম্পূর্ণ বাংলায় — কোনো ভাষাগত সমস্যা নেই",
      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <span className="text-primary font-semibold text-sm uppercase tracking-wider">কেন হিসাব?</span>
            <h2 className="text-3xl md:text-4xl font-bold mt-3 mb-6">
              কেন এই অ্যাপ <span className="text-gradient">অন্যদের চেয়ে আলাদা</span>
            </h2>
            <p className="text-muted-foreground mb-8 leading-relaxed">
              বাজারে অনেক Expense Tracker আছে, কিন্তু বাংলাদেশের মানুষের জন্য বাংলায় তৈরি, সিম্পল ও কার্যকর অ্যাপ খুবই কম। হিসাব অ্যাপ সেই শূন্যতা পূরণ করতে এসেছে।
            </p>
          ...
          >
            <div className="bg-hero-gradient rounded-3xl p-8 md:p-12 text-primary-foreground max-w-md">
              ...
              <p className="opacity-90 leading-relaxed text-sm">
                গবেষণায় দেখা গেছে, যারা নিয়মিত খরচ ট্র্যাক করেন তারা মাসে গড়ে ১৫-২০% বেশি সঞ্চয় করতে পারেন। হিসাব অ্যাপ দিয়ে আজই শুরু করুন।
              </p>
