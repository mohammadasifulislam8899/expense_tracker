...
const testimonials = [
  {
    ...
    text: "আগে কোথায় টাকা যেত বুঝতামই না! হিসাব অ্যাপ ব্যবহার করে এখন প্রতি মাসে সঞ্চয় করতে পারছি।",
    rating: 5,
  },
  {
    name: "ফারিয়া আক্তার",
    role: "গৃহিণী",
    text: "বাংলায় হওয়ায় ব্যবহার করতে অনেক সহজ। বাচ্চাদের খরচ, বাজার খরচ সব আলাদা আলাদা ট্র্যাক করি।",
    rating: 5,
  },
  {
    name: "তানভীর আহমেদ",
