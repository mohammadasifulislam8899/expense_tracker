...
const faqs = [
  {
    ...
    a: "হ্যাঁ! Expense Tracker অ্যাপ সম্পূর্ণ অফলাইনে কাজ করে। ইন্টারনেট সংযোগ পেলে স্বয়ংক্রিয়ভাবে ডেটা সিঙ্ক হয়ে যায়।",
  },
  {
  ...
  },
  {
    ...
    a: "হ্যাঁ, Expense Tracker অ্যাপ সম্পূর্ণ বিনামূল্যে ব্যবহার করা যায়। কোনো hidden charge বা in-app purchase নেই।",
  },
  {
    q: "কোন কোন ফোনে চলে?",
